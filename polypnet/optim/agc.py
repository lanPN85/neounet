"""
Based on https://github.com/vballoli/nfnets-pytorch/blob/main/nfnets/agc.py
"""
...
class AGC(optim.Optimizer):
    ...
    Args:
      ...
      clipping (float, optional): clipping value (default: 0.3)
    ...
    def __init__(self, params, optim_: optim.Optimizer, clipping: float = 0.3, eps: float = 1e-3, model=None, ignore_agc=tuple()):
        ...
        defaults = {**defaults, **optim_.defaults}
