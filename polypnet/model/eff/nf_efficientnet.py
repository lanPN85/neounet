...
class NFMBConvBlock(nn.Module):
    """Normalizer-free Mobile Inverted Residual Bottleneck Block.
...
class NFEfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None):
        ...
        for block_args in self._blocks_args:
            ...
            self._blocks.append(
                NFMBConvBlock(block_args, self._global_params, image_size=image_size)
            )
